...
import { CButton, CFormGroup, CLabel, CFormText, CInput, CCol, CLink, CSwitch, CCardHeader, CCard, CCardBody, CCardFooter, CTooltip, CRow, CTabPane, CModalBody, CModalHeader, CModalTitle, CModalFooter, CNavItem, CNavLink, CTabContent, CNav, CTabs, CModal } from '@coreui/react';
...
class Kyc_Requests_Add extends Component {
  constructor(props) {
    super(props);
      ...
      <CCard>
        ...
        <CCardBody>
          <CFormGroup>
            ...
            <CInput type="text" id="title" name="title" placeholder="Enter Title" autoComplete="title" onChange={this.handleChange} />
          ...
          <CFormGroup>
            ...
            <CInput type="text" id="meta_title" name="meta_title" placeholder="Enter Meta Title " autoComplete="meta_title" onChange={this.handleChange} />
          </CFormGroup>
          <CFormGroup>
            <CLabel htmlFor="nf-name">Meta Keywords</CLabel>
            <CInput type="text" id="meta_keywords" name="meta_keywords" placeholder="Enter Meta Keywords " autoComplete="meta_keywords" onChange={this.handleChange} />
          </CFormGroup>
          <CFormGroup>
            <CLabel htmlFor="nf-name">Meta Description</CLabel>
            <CInput type="text" id="meta_desc" name="meta_desc" placeholder="Enter Meta Description" autoComplete="meta_desc" onChange={this.handleChange} />
          </CFormGroup>
          <CFormGroup>
...
export default Kyc_Requests_Add
