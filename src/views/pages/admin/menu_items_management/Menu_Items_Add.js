...
class Menu_Items_Add extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      menu_title: '',
      menu_types: 'custom',
      menu_category_id: this.props.match.params.id,
      order: 0,
      cms_page: []
  ...
  componentDidMount() {
    ...
    this.getcmsListing();
    var next_order = (this.props.location.state !== null && this.props.location.state !== undefined) ? this.props.location.state.next_order : 1;
    this.setState({ order: next_order });
  }
 /********** Get Cms Pages Listng  ************/
  getcmsListing() {
  ...
  handleSubmit() {
    if (this.validator.allValid()) {
      MenuitemServices.createitem(this.state).then(res => {
        if (res.status === false) {
          notify.error(res.message);
        } else {
          ...
          <CCard>
            ...
            <CCardBody>
              ...
              <CFormGroup >
                ...
                <CInput type="text" id="menu_title" name="menu_title" placeholder="Menu Title" autoComplete="menu_category " onChange={this.handleInputChange} />
              ...
              <CFormGroup >
                ...
                <CSelect custom name="menu_types" id="select" onChange={this.handleInputChange}>
